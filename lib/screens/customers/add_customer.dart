...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  void _autofillExisting(String phone) {
    ...
    if (existing != null) {
      ...
      _styles..clear()..addAll(existing.styles);
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 8),
            Wrap(spacing: 8, runSpacing: 8, children: _styleOptions.map((s) => FilterChip(label: Text(s), selected: _styles.contains(s), onSelected: (v) => setState(() => v ? _styles.add(s) : _styles.remove(s)))).toList()),
            const SizedBox(height: 16),
