...
class _CustomersListScreenState extends State<CustomersListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Customers'), backgroundColor: indigo, elevation: 0),
      body: Column(
        children: [
          Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                CircleAvatar(radius: 20, backgroundImage: avatar, child: avatar == null ? const Icon(Icons.person, size: 18) : null),
...
class OrdersListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _IosListScaffold(
      title: 'Orders',
      items: items,
      detailBuilder: (item) => OrderTrackingScreen(
        orderId: item.title,
...
class StaffListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _IosListScaffold(title: 'Staff', items: items, detailBuilder: (item) => DetailScreen(item: item));
  }
}
...
class _IosListScaffold extends StatefulWidget {
  ...
  const _IosListScaffold({required this.title, required this.items, required this.detailBuilder});
...
class _IosListScaffoldState extends State<_IosListScaffold> {
  ...
  Widget build(BuildContext context) {
    const indigo = Color(0xFF1A237E);
    return Scaffold(
      appBar: AppBar(title: Text(widget.title), backgroundColor: indigo, elevation: 0),
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(backgroundColor: const Color(0xFFFFD700).withValues(alpha: 0.2), child: const Icon(Icons.arrow_forward_ios, color: Color(0xFFFFD700), size: 16)),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const indigo = Color(0xFF1A237E);
    return Scaffold(
      appBar: AppBar(title: Text(item.title), backgroundColor: indigo, elevation: 0),
      body: Center(
        child: Hero(
